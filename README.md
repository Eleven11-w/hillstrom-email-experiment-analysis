...
带置信区间的正式版本及数字映射见`docs/resume_bullets.md`；五分钟讲解稿与12个追问答案见`docs/interview_kit.md`；B7门禁见`docs/b7_acceptance_report.md`。本人完成一次不超过5分钟的计时讲解前，不把Gate B-Resume标记为完全通过。
